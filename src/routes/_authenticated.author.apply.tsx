...
export const Route = createFileRoute("/_authenticated/author/apply")({
  head: () => ({
    meta: [{ title: "Apply as author — FAVNOL" }, { name: "robots", content: "noindex" }],
  }),
  component: ApplyPage,
});
  ...
  if (isAuthor) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <Button asChild>
          <Link to="/author">{t("apply.dashboard")}</Link>
        </Button>
      </div>
    );
  }
      ...
      >
        <Field label={t("apply.penName")}>
          <input
            ...
            maxLength={80}
            className="input"
            placeholder={t("apply.penName.ph")}
          />
        </Field>
