...
const TITLE = "الروايات المستمرة | FAVNOL";
const DESC = "روايات ما زالت مستمرّة على FAVNOL مع فصول جديدة تُنشر باستمرار.";
...
export const Route = createFileRoute("/ongoing")({
  loader: async ({ context: { queryClient } }) => {
    await queryClient
      .prefetchQuery({
        ...
        queryFn: () => fetchNovels({ status: "ongoing" }),
        staleTime: 60_000,
      })
      .catch(() => undefined);
  },
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: canonicalUrl("/ongoing") },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: canonicalUrl("/ongoing") }],
  }),
