...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "اقرأ آلاف الروايات المترجمة مجاناً على منصة UR Fav Novel. فانتازيا، أكشن، رومانسي، خيال علمي وأكثر." },
      { name: "theme-color", content: "#0a0a0a" },
      { property: "og:title", content: "UR Fav Novel — منصة قراءة الروايات المترجمة" },
      { property: "og:description", content: "منصة عربية عصرية لقراءة أفضل الروايات المترجمة." },
