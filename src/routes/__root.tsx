...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "اقرأ آلاف الروايات  مجاناً: فانتازيا، أكشن، رومانسي، تنمية ذاتية، خيال علمي وأكثر." },
      { name: "theme-color", content: "#0a0a0a" },
      { property: "og:title", content: "UR Fav Novel — منصة قراءة الروايات " },
      { property: "og:description", content: "اقرأ آلاف الروايات  مجاناً: فانتازيا، أكشن، رومانسي، تنمية ذاتية، خيال علمي وأكثر." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "UR Fav Novel — منصة قراءة الروايات " },
      { name: "twitter:description", content: "اقرأ آلاف الروايات  مجاناً: فانتازيا، أكشن، رومانسي، تنمية ذاتية، خيال علمي وأكثر." },
