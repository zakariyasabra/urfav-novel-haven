...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "شروط الاستخدام — UR Fav Novel" },
      { name: "description", content: "الشروط والأحكام لاستخدام منصة UR Fav Novel." },
  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose-reading space-y-4 text-foreground/90">
        <p>باستخدامك لمنصة UR Fav Novel فإنك توافق على الشروط التالية:</p>
        <h2 className="text-2xl font-bold">1. المحتوى</h2>
        <p>جميع الروايات المعروضة هي أعمال مترجمة تخضع لحقوق أصحابها الأصليين. UR Fav Novel منصة تجميع فقط.</p>
