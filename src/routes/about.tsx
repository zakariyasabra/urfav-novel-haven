  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose-reading space-y-4 text-foreground/90">
        <p>
          FAVNOL هي منصة عربية مخصصة لعشاق الروايات تأسست بهدف تقديم تجربة قراءة عصرية وأنيقة تليق
          بالقارئ العربي.
        </p>
        <p>
          نؤمن بأن القصص العظيمة تستحق أن تُقرأ بأفضل شكل ممكن. لذلك بنينا منصة سريعة، وبواجهة مصممة
          خصيصاً للقراءة المطولة.
        </p>
        <h2 className="text-2xl font-bold">رؤيتنا</h2>
        <p>
          أن نصبح الوجهة الأولى لقراء الروايات في العالم العربي، وأن نمنح منصة عادلة لعرض أعمالهم.
        </p>
