      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4 text-sm">
          <p className="text-muted-foreground">
            سيمنحك هذا الشراء وصولاً دائماً إلى جميع فصول{" "}
            <span className="font-bold text-foreground">{novelTitle}</span> — الحالية والمستقبلية —
            دون الحاجة لفتح كل فصل على حدة.
          </p>
